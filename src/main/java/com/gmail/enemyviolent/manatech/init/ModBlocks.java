...
public class ModBlocks {
	...
	public static Block manastone_ore = new BlockManatech(1.0F, 3.0F, "pickaxe", 2, 0F, Material.rock).setUnlocalizedName("manastone_ore");
	public static Block manastone_block = new BlockManatech(1.0F, 3.0F, "pickaxe", 2, 0F, Material.iron).setUnlocalizedName("manastone_block");
